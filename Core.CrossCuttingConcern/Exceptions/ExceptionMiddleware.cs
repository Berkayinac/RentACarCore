using Core.CrossCuttingConcern.Exceptions.Handlers;
...
{
    // ExceptionMiddleware ->  Request delegation'ı ile yapılıyor
    // _next isimlendirmesi .net tarafından kullanılan isimlendirmedir. Bir sonraki çalıştırılacak metodu middleware ile arasına girebilmek için kullanılır.
    ...
    // Tüm metotları try-catch yazmayım onun yerine tek bir tane olsun hepsini onun içinden geçireyim
